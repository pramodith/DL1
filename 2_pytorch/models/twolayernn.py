...
class TwoLayerNN(nn.Module):
    def __init__(self, im_size, hidden_dim, n_classes):
        ...
        #############################################################################
        self.linear1=nn.Linear(im_size[0]*im_size[1]*im_size[2],hidden_dim)
    ...
    def forward(self, images):
        ...
        #############################################################################
        out1=F.relu(self.linear1(images.reshape(images.shape[0],-1)))
        scores=F.softmax(self.linear2(out1))
